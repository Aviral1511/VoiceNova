...
const Customize2 = () => {
    ...
    return (
        <div className='w-full h-screen bg-linear-to-t from-[#000000fd] to-[#0202b4e7] flex justify-center items-center flex-col'>
            ...
            {assistantName.length > 0 && <button className='h-12 min-w-30 rounded-full bg-gray-200 text-lg font-semibold text-black cursor-pointer mt-3 hover:bg-gray-300' onClick={() => { navigate('/'); handleSubmit() }}>Let's Go</button>}
        </div>
    )
}
